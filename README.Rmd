...
ggplot(df, aes(x = x, y = y)) +
  geom_beeswarm(cex = 2.5, method = "swarm") +
  ggtitle('method = "swarm" (default)')
ggplot(df, aes(x = x, y = y)) +
  geom_beeswarm(cex = 2.5, method = "compactswarm") +
  ggtitle('method = "compactswarm"')
ggplot(df, aes(x = x, y = y)) +
  geom_beeswarm(cex = 2.5, method = "hex") +
  ggtitle('method = "hex"')
ggplot(df, aes(x = x, y = y)) +
  geom_beeswarm(cex = 2.5, method = "square") +
  ggtitle('method = "square"')
ggplot(df, aes(x = x, y = y)) +
  geom_beeswarm(cex = 2.5, method = "center") +
  ggtitle('method = "center"')
```
...
ggplot(dat, aes(x, y)) +
  geom_beeswarm(cex = 2) +
  ggtitle("Default (ascending)") +
  scale_x_continuous(expand = expansion(add = c(0.5, .5)))
ggplot(dat, aes(x, y)) +
...
ggplot(dat, aes(x, y)) +
  ...
  scale_x_continuous(expand = expansion(add = c(0.5, .5)))
ggplot(dat, aes(x, y)) +
  geom_beeswarm(cex = 2, priority = "random") +
  ggtitle("Random") +
  scale_x_continuous(expand = expansion(add = c(0.5, .5)))
```
